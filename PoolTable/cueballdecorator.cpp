...
{
    //connect dialog signals to cueball slots so that this class is notified when the mouse is used and cueball reset
    ...
    connect(parent,&Dialog::setCueBall,this,&CueBallDecorator::setCueBall);
}
...
void CueBallDecorator::setCueBall(Ball* ball){
    m_ball = ball;
}
